        ...
        {menuItem.submenu ? (
          <>
            <button
              ...
              className={`flex cursor-pointer items-center justify-between gap-3 ${menuItem.disabled ? 'text-gray-400 cursor-not-allowed' : 'hover:text-primary'}`}
          ...
          className={`${
            ...
            menuItem.disabled && 'hover:text-white'
          }`}
          onClick={(e) => menuItem.disabled && e.preventDefault()}
        >
          {menuItem.title}
       </Link>
        )}
