...
// // Logo html react nxt css js flutter dm
// const Integration = () => {
//   return (
//     <>
//       <section>
      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `OUR EXPERTISE`,
              subtitle: `Comprehensive Web Development and SEO Services`,
              description: `At ZedoftTech, we empower businesses with top-notch web development and SEO solutions. Leveraging technologies such as HTML, React, Next.js, CSS, JavaScript, and Flutter, we build and optimize websites to meet your business goals and ensure you reach your target audience effectively.`,
            }}
          />
